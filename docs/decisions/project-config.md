...
| 字段                 | 值                                      | 确认日期   |
| -------------------- | --------------------------------------- | ---------- |
| npm 包名 / 发布      | `create-vben` · GitHub Actions tag 发版 | 2026-06-09 |
| CLI bin              | `create-vben`                           | 2026-06-09 |
| **集成分支**         | **`dev`**                               | 2026-06-09 |
| **当前工作分支**     | **`v1.0.0`**                            | 2026-06-09 |
...
| 默认 upstream ref                       | ⬜ Q2                                         |
| npm scope / 发布账号                    | ✅ Q4 · `create-vben` · Actions + `NPM_TOKEN` |
| 生成后自动 install                      | ⬜ Q5                                         |
